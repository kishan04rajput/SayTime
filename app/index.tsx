...
export default function Index() {
  ...
  return (
    ...
    >
      <Dropdown
        style={{ width: 100, height: 50, borderColor: 'gray', borderWidth: 1, marginBottom: 20 }}
        data={hour}
        labelField="label"
        valueField="value"
        placeholder={selectedHour}
        onChange={(e)=>{updateSelectedHour(e)}}
      />
      <Dropdown
        style={{ width: 100, height: 50, borderColor: 'gray', borderWidth: 1, marginBottom: 20 }}
        data={minute}
        ...
        onChange={(e)=>{updateSelectedMinute(e)}}
      />
      <Dropdown
        style={{ width: 100, height: 50, borderColor: 'gray', borderWidth: 1, marginBottom: 20 }}
        data={ampm}
        ...
        onChange={(e)=>{updateSelectedAmPm(e)}}
      />
